...
<Aside type="caution">
This section talks about different section, Global Offset Table, Procedure Link Table, etc. For more information on these data sections, tables and how they are placed in memory, refer to ELF Specification and Dynamic Linking internals. Or, you can refer to my notes on [ELF](../04-elf) and [DSOs](../03-dso).
</Aside>
