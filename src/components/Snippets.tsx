...
type Props = {
  tags: string[]
  data: CollectionEntry<"snippets">[]
}

export default function Snippets({ data, tags }: Props) {
  const [filter, setFilter] = createSignal(new Set<string>())
  const [posts, setPosts] = createSignal<CollectionEntry<"snippets">[]>([])
      ...
      <div class="col-span-3 sm:col-span-2">
        <div class="flex flex-col">
          <div class="text-sm uppercase mb-2">
            SHOWING {posts().length} OF {data.length} SNIPPETS
          </div>
